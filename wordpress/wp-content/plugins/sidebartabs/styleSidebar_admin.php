...
#colorpicker301 { margin: 800px 0 0 500px !important; }
...
div.corner  { float: left; width: 50px; height: 10px; padding: 10px; margin: 0 0.7em 0.7em 0; background: #464646; }
div.bvtp { float: left; width: 100px; height: 30px; margin: 0 0.7em 0.7em 0; background: url(images/vertical_bg.png) repeat-x; }
div.bvtd { float: left; width: 100px; height: 30px; margin: 0 0.7em 0.7em 0; background: <?php echo $opsbt["active_bg"]; ?>  url(images/h30.png) repeat-x; color: <?php echo $opsbt["active_font"]; ?> ;}
div.bvtn { float: left; width: 100px; height: 30px; margin: 0 0.7em 0.7em 0; background-color: <?php echo $opsbt["active_bg"]; ?>; color: <?php echo $opsbt["active_font"]; ?>;}
.icon-sidebarTabs {
