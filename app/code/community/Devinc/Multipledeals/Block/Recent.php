<?php
class Devinc_Multipledeals_Block_Recent extends Mage_Core_Block_Template
{
	public function getLoadedProductCollection()
    {
		$multipledeals_collection = Mage::getModel('multipledeals/multipledeals')->getCollection()->addFieldToFilter('status', array('eq'=>'4'))->addFieldToFilter('type', array('eq'=>'3'))->setOrder('multipledeals_id', 'DESC');
    ...
    {	
		...
		$multipledeals = Mage::getModel('multipledeals/multipledeals')->getCollection()->addFieldToFilter('status', array('eq' => 4))->addFieldToFilter('product_id', array('eq' => $_product->getId()))->getFirstItem();
