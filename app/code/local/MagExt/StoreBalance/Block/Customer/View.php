...
/**
 * Store balance view for customer's area
 *
 * @author  MagExtension Development team
 */ 
class MagExt_StoreBalance_Block_Customer_View extends Mage_Core_Block_Template 
{
	public function __construct()
	{
	    $this->setTemplate('mgxstorebalance/customer/view.phtml');
	}
}