...
/**
 * Coupon History Resource Model
 *
 * @author  MagExtension Development team
 */
class MagExt_StoreBalance_Model_Mysql4_Coupon_History extends Mage_Core_Model_Mysql4_Abstract
{
	protected function _construct()
	{
		$this->_init('mgxstorebalance/coupon_history', 'history_id');
	}
